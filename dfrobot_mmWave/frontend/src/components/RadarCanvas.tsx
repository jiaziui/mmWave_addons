...
import { formatRegionLiveInfo } from "../utils/regionManagement";
...
): string => formatRegionLiveInfo(region.regionType ?? "empty_tag", region, t);
...
export function RadarCanvas({
  ...
  const fillVisible = viewPreferences?.fillVisible ?? true;
  ...
  return (
    <svg
      ref={svgRef}
      className={[
        large ? "radar-canvas radar-canvas-large" : "radar-canvas",
