...
exports.tagTypeCodeToName = exports.parseTagEventSnapshot = void 0;
const normalizeString = (value) => typeof value === "string" ? value.trim().toLowerCase() : "";
const normalizeRouteString = (value) => typeof value === "string" ? value.trim() : "";
const routeFromTopic = (topic) => {
...
const normalizeBoundaryState = (value) => {
...
const normalizeApproachAwayState = (value) => {
    const normalized = normalizeString(value);
...
const parseTagEventSnapshot = (topic, payload) => {
    try {
        ...
        if (normalizedTypeFromName !== null &&
...
exports.parseTagEventSnapshot = parseTagEventSnapshot;
const tagTypeCodeToName = (value) => tagTypeByCode(value);
exports.tagTypeCodeToName = tagTypeCodeToName;
