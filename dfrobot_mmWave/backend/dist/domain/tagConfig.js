...
exports.buildMultiTagConfigHex = void 0;
const TAG_CONFIG_LIMIT = 32;
const TAG_CONFIG_RECORD_LEN = 12;
const tagTypeByRegionType = {
    status_detection: 3,
    boundary: 1,
    approach_depart: 2,
    noise: 4,
...
const encodeRegionRecord = (region) => {
...
const buildMultiTagConfigHex = (regionConfig) => {
...
exports.buildMultiTagConfigHex = buildMultiTagConfigHex;
