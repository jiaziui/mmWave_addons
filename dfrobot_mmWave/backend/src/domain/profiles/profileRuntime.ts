...
const entityDefinitions: C4004EntityDefinition[] = [
  ...
  { key: "liveCount", domain: "sensor", slug: "live_count", access: "read" },
  ...
  { key: "trkLed", domain: "switch", slug: "trk_led", access: "readwrite" },
  { key: "occLed", domain: "switch", slug: "occ_led", access: "readwrite" },
  ...
  { key: "realTimeReportInterval", domain: "number", slug: "real_time_report_interval", access: "readwrite" },
  { key: "trajectoryGenerationDistance", domain: "number", slug: "trajectory_generation_distance", access: "readwrite" },
  { key: "trajectoryLifetime", domain: "number", slug: "trajectory_lifetime", access: "readwrite" },
  { key: "frameGenerateCount", domain: "number", slug: "frame_generate_count", access: "readwrite" },
  { key: "unoccupiedTime", domain: "number", slug: "unoccupied_time", access: "readwrite" },
  ...
  { key: "clearLiveCount", domain: "button", slug: "clear_live_count", access: "action" },
